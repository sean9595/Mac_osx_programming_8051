 ...
 while (1) //infinite loop
  {
	  if(btn_int_flag)
	  {
        ...
        if(btn_01)
        {
         ...
         {
         case 0:
             while(btn_02) //Since I use Schmitt trigger, there will be no error for checking btn_02.
             {
                 year_set();
                 // year_disp();
             }
...
{
  year_bcd++;
  if(year_bcd==0x0a) year_bcd=0x10;
  else if(year_bcd==0x1a) year_bcd=0x20;
  else if(year_bcd==0x2a) year_bcd=0x30;
  else if(year_bcd==0x3a) year_bcd=0x40;
  else if(year_bcd==0x4a) year_bcd=0x50;
  else if(year_bcd==0x5a) year_bcd=0x60;
  else if(year_bcd==0x6a) year_bcd=0x70;
  else if(year_bcd==0x7a) year_bcd=0x80;
  else if(year_bcd==0x8a) year_bcd=0x90;
  else if(year_bcd==0x9a) year_bcd=0x00;
...
{
  mnth_bcd++;
  if(mnth_bcd==0x0a) mnth_bcd=0x10;
  else if(mnth_bcd==0x13) mnth_bcd=0x01;
...
{
  date_bcd++;
  if(date_bcd==0x0a) date_bcd=0x10;
  else if(date_bcd==0x1a) date_bcd=0x20;
  else if(date_bcd==0x2a) date_bcd=0x30;
  else if(date_bcd==0x32) date_bcd=0x01;
...
{
  hr_bcd++;
  if(hr_bcd==0x8a) hr_bcd=0x80|0x10;
  else if(hr_bcd==0x93) hr_bcd=(0x80|0x01)|0x20; //AM->PM
  else if(hr_bcd==0xaa) hr_bcd=0xa0|0x10;
  else if(hr_bcd==0xb3) hr_bcd=0x80;
...
{
   min_bcd++;
   if(min_bcd==0x0a) min_bcd=0x10;
   else if(min_bcd==0x1a) min_bcd=0x20;
   else if(min_bcd==0x2a) min_bcd=0x30;
   else if(min_bcd==0x3a) min_bcd=0x40;
   else if(min_bcd==0x4a) min_bcd=0x50;
   else if(min_bcd==0x5a) min_bcd=0x00;
